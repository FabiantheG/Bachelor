...
def ols(cur_list, hedge_logreturn, factors, window=60, duration=1):
    ...
    return hedge_ratio_df.astype(float), hit_ratio_dict

def ols_mean(cur_list, hedge_logreturn, factors, window=60, duration=1):
    # Gemeinsamer Index vorbereiten
    factors['dollar_shifted'] = factors['dollar'].shift(-1)
    factors['carry_shifted'] = factors['carry'].shift(-1)
...
def ols_tminus1(cur_list, hedge_logreturn, factors, window=60, duration=1):
    # Gemeinsamer Index vorbereiten
    factors['dollar_shifted'] = factors['dollar'].shift(-1)
    factors['carry_shifted'] = factors['carry'].shift(-1)
